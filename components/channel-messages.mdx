---
title: "Channel Messages View — Full-Featured Chat Thread"
...
```kotlin
messagesListView.setMessageClickListener(object : MessageClickListeners() {
...
```kotlin
messagesListView.setMessageActionsClickListener(object : MessageActionsViewClickListeners() {
...
```kotlin
messagesListView.setReactionPopupClickListener(object : ReactionPopupClickListeners() {
