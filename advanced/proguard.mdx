---
title: "ProGuard and R8 Rules for Sceyt Chat Android UIKit"
sidebarTitle: "ProGuard"
description: "Add the required ProGuard and R8 keep rules for Sceyt Chat Android UIKit to prevent code shrinking from stripping necessary classes."
---
